...
public class BaseballGame {
	...
	public static void main(String[] args) {
		/*
		 * 숫자야구 게임 - 중복되지 않은 1~9사이의 랜덤한 수를 생성 - 이 세 수를 맞추는 게임 - 스트라이크 : 해당 숫자가 있고, 위치도
		 * 같은 경우 - 볼 : 숫자는 있지만 위치가 다른 경우 - 아웃 : 일치하는 숫자가 하나도 없는 경우 (3 9 7) 입력 : 1 2 3 1B
		 * 입력 : 5 6 7 1S 입력 : 4 5 6 Out 입력 : 3 7 9 1S2B 입력 : 3 9 7 3S 정답입니다.
		 */
